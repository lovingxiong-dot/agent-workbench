...
"""PyInstaller spec for AI Agent Workbench V4 (archived legacy UI)."""
import os
import PySide6
...
a = Analysis(
    [os.path.join(spec_dir, 'v4_main.py')],
    pathex=[],
    binaries=[],
    datas=[
        (os.path.join(project_root, 'config', 'config.yaml'), 'config'),
        (os.path.join(project_root, 'assets', 'app.ico'), 'assets'),
        (os.path.join(project_root, r'venv\Lib\site-packages\certifi\cacert.pem'), 'certifi'),
    ] + webengine_datas,
    hiddenimports=[
        # Core infrastructure
        'yaml',
        ...
        'core.event_bus',
        'core.events',
        # V4 legacy UI architecture (archived)
        'v4.main_window',
        'v4.repository',
        'v4.event_bus',
        'v4.orchestrator',
        ...
        'v4.queue',
        'v4.widgets.base',
        'v4.widgets.window_frame',
        'v4.widgets.left_panel',
        'v4.widgets.chat_items',
        'v4.widgets.chat_scene',
        'v4.widgets.chat_area',
        'v4.widgets.right_panel',
        'v4.widgets.terminal_widget',
        'v4.widgets.file_reader_widget',
        'v4.widgets.browser_widget',
        'v4.widgets.settings_dialog',
    ...
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[os.path.join(project_root, 'scripts', 'runtime_hook.py')],
    excludes=[
