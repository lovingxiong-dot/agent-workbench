...
| v2.0 | 2026-07-23 | OD-C0-002 v1.1 (capability vs pattern distinction) + [OD-C0-003 Consumer Diversity Observation](../../observations/OD-C0-003-consumer-diversity-observation.md): 3 consumers found (1 Adapter + 2 Observation), 6 categories absent. Phase 2-E.3 CLOSED. |
| v2.1 | 2026-07-23 | [OD-EX0-001 External Agent Ecosystem Pattern Observation](../../observations/OD-EX0-001-external-agent-ecosystem-pattern.md) — external READ-ONLY pattern observation (4 agents, 16 skills, 2-layer memory). No Workbench v6 change. Architecture Mapping deferred to separate ADR. |
| v2.2 | 2026-07-23 | EX-0/EX-1/EX-2 convergence: [OD-EX0-003 v6 Constitution Synthesis](../../observations/OD-EX0-003-v6-constitution-external-synthesis.md) (5-Layer Model + ADR-DRAFT-010 candidate-only) + Phase EX-1 [Architecture Knowledge Map](../../observations/architecture-map/README.md) (17 files, Indexed, NOT Contract) + [OD-EX0-004 A1 Entry Condition](../../observations/OD-EX0-004-a1-entry-condition.md) (Criterion 1+2 MET, Criterion 3 waiting). Architecture calibration COMPLETE. |