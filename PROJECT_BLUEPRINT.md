...
# Project Blueprint
## 元信息
| 项目名称 | AI Agent 工作台 | 当前版本 | v6.8.0-alpha | 公开立项标签 | v6.0.0-alpha | 内部迁移标签 | v6.5.8-alpha | 存档次数 | 34 |
...
## V6 分支策略（自 v6.8.0-alpha 起生效）

`v6.8.0-alpha`（V6 Framework Core Foundation）起，V6 从单分支演进拆为三条垂直支线：
