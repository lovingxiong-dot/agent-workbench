...
| 版本 | 日期 | 描述 | 类型 | 涉及文件 |
|---|---|---|---|---|
| v6.0.1-alpha | 2026-07-07 | V6 Runtime协议深化：RuntimeContext新增new()工厂自动生成task_id；Service层统一(ctx)接口；UIController全面改用RuntimeContext；SPEC补充Runtime Interface Principle与Task语义；修复测试docstring语法错误；90/90测试通过 | refactor/feat/docs/test | v6/runtime/context.py, v6/services/*.py, v6/ui_controller.py, tests/v6/*.py, docs/v6/SPEC.md |
