...
TOOL_DEFINITIONS = [
    ...
    {"type":"function","function":{"name":"run_python","description":"[PRIORITY-2] Execute a Python code snippet using project venv or system Python. Use for calculations, data processing, or quick scripts.","parameters":{"type":"object","properties":{"code":{"type":"string","description":"Python code snippet"}},"required":["code"]}}},
    {"type":"function","function":{"name":"run_powershell","description":"[PRIORITY-2] Execute a PowerShell command. Use for Windows-specific operations.","parameters":{"type":"object","properties":{"command":{"type":"string","description":"PowerShell command"}},"required":["command"]}}},
    {"type":"function","function":{"name":"run_bash","description":"[PRIORITY-2] Execute a Bash command via Git Bash. Use for Unix-style shell operations on Windows.","parameters":{"type":"object","properties":{"command":{"type":"string","description":"Bash command"}},"required":["command"]}}},
